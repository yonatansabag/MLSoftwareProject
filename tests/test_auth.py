...
class AuthTest(unittest.TestCase):
    ...
    def test_successful_signup_and_login(self):
        ...
        if existing_user:
            mongo_users.User.delete_user(existing_user.username)
        ...
        # Check for success status code instead of redirect
        self.assertEqual(200, response_signup.status_code)  # Now expecting 200
        ...
        if response_signup.status_code == 200:
            ...
            self.assertEqual(200, login_response.status_code)  # Check for redirect on login
